...
static const char * const mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll8_gpll0_gpll0_div[] = {
	"xo",
	"mmpll0",
	"mmpll4",
	"mmpll7",
...
static const char * const mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_gpll0_div[] = {
	"xo",
	"mmpll0",
	"mmpll4",
	"mmpll7",
...
static const char * const mmcc_xo_mmpll4_mmpll7_mmpll10_sleep_gpll0_gpll0_div[] = {
	"xo",
	"mmpll4",
	"mmpll7",
	"mmpll10",
...
static const char * const mmcc_xo_mmpll0_mmpll7_mmpll10_sleep_gpll0_gpll0_div[] = {
	"xo",
	"mmpll0",
	"mmpll7",
	"mmpll10",
...
static const char * const mmcc_xo_gpll0_gpll0_div[] = {
	"xo",
	"gpll0",
	"gpll0_div",
	"core_bi_pll_test_se",
...
static const char * const mmcc_xo_dplink_dpvco[] = {
	"xo",
...
static const char * const mmcc_xo_mmpll0_mmpll5_mmpll7_gpll0_gpll0_div[] = {
	"xo",
	"mmpll0",
	"mmpll5",
	"mmpll7",
...
static const char * const mmcc_mmpll0_mmpll4_mmpll7_mmpll10_mmpll6_gpll0[] = {
	"xo",
	"mmpll0",
	"mmpll4",
	"mmpll7",
...
static const char * const mmcc_xo_mmpll0_gpll0_gpll0_div[] = {
	"xo",
	"mmpll0",
	"gpll0",
	"gpll0_div",
...
static const char * const mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_mmpll6[] = {
	"xo",
	"mmpll0",
	"mmpll4",
	"mmpll7",
...
static const char * const mmcc_xo_mmpll0_mmpll8_mmpll3_mmpll6_gpll0_mmpll7[] = {
	"xo",
	"mmpll0",
	"mmpll8",
	"mmpll3",
...
static struct clk_rcg2 camss_gp0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_names = mmcc_xo_mmpll0_mmpll7_mmpll10_sleep_gpll0_gpll0_div,
		.num_parents = 8,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 cpp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "cpp_clk_src",
		.parent_names = mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll10_gpll0_mmpll6,
		.num_parents = 8,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 csi0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "csi0_clk_src",
		.parent_names = mmcc_xo_mmpll0_mmpll4_mmpll7_mmpll8_gpll0_gpll0_div,
		.num_parents = 8,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 dp_aux_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "dp_aux_clk_src",
		.parent_names = mmcc_xo_gpll0_gpll0_div,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 dp_crypto_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_names = mmcc_xo_dplink_dpvco,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 mclk0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "mclk0_clk_src",
		.parent_names = mmcc_xo_mmpll4_mmpll7_mmpll10_sleep_gpll0_gpll0_div,
		.num_parents = 8,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 mdp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "mdp_clk_src",
		.parent_names = mmcc_xo_mmpll0_mmpll5_mmpll7_gpll0_gpll0_div,
		.num_parents = 7,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 pclk0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "pclk0_clk_src",
		.parent_names = mmcc_xo_dsi0pll_dsi1pll,
		.num_parents = 4,
		.ops = &clk_pixel_ops,
		.flags = CLK_SET_RATE_PARENT | CLK_GET_RATE_NOCACHE,
	},
...
static struct clk_rcg2 vfe0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "vfe0_clk_src",
		.parent_names = mmcc_mmpll0_mmpll4_mmpll7_mmpll10_mmpll6_gpll0,
		.num_parents = 8,
		.ops = &clk_rcg2_ops,
	},
};
